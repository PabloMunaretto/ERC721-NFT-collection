...
## Habŕia que hacer otro folder dentro de metadata/rinkeby subiendo el json de la metadata completa
## para no usar este json hardcodeado
dog_metadata_dic = {
...
def main():
    ...
    print("the number of tokens " + str(number_of_collectibles))
    for token_id in range(number_of_collectibles):
        ...
        if not advanced_collectible.tokenURI(token_id).startswith("https://"):
            ...
            print("Skipping {}, we've already set that token URI!".format(token_id))
